(ns opm.json
  (:require [opm.database :as database])
  (:use [clojure.data.json]
        [opm.model :only [create-datapoint refresh create-device fetch-series-id store create-series fetch-series fetch-datapoints]])
